  ...
  return (
    <AnimateIn>
      <div className="flex flex-col justify-center h-full py-8">
        ...
        {/* Large Heading */}
        <AnimateIn delay={0.4}><h2 className="text-3xl font-title-size max-w-[90%] md:text-4xl lg:text-4xl font-parkinsans font-regular mt-3 mb-5">
          Choose Cornerstone Floor Care LLC, Choose Quality
        </h2></AnimateIn>
