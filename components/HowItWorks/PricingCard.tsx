...
export default function PricingCard({ data }: PricingCardProps) {
  return (
    <>
      ...
      <div
        className={`relative p-8 pt-12 font-parkinsans pricing-cards-width text-center shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col items-center justify-start ${data.isWide ? 'flex-[1.6]' : 'flex-1.55'}`}
        style={{
