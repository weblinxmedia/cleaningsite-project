  ...
  return (
    <div className="text-left md:text-center mb-8 md:mb-16">
      ...
      <AnimateIn delay={0.25}>
        <h2 className="text-3xl w-full md:w-[40vw] font-title-size text-black mx-auto md:text-5xl lg:text-[2.4rem] font-parkinsans leading-tight font-regular mt-3 mb-5">
