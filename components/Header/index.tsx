        ...
        <div className="flex items-center justify-between h-full mx-auto" style={{ maxWidth: '1280px' }}>
          ...
          <div className="hidden md:flex items-center gap-5">
            <button className="text-gray-500 nav-icon hover:text-luxury-pink transition-colors duration-300 text-xl" aria-label="Info">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="black" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
                <path d="M17.5 3V10M21 6.5H14" strokeLinejoin="round"></path>
