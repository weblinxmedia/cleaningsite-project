    ...
    <div className="w-full hero-card h-full md:max-w-[63vw] mx-auto px-0 md:px-4">
      ...
      >
        <div className='w-full md:w-[98%] mx-auto'>
          ...
          <h1 className="font-parkinsans text-2xl w-full md:w-[100%] mx-auto md:text-4xl lg:text-[40px] font-normal text-center md:text-center text-luxury-dark leading-tight mb-2 md:mb-4">
            {hero_heading || 'Looking for High Quality Cleaning Service? Quote Us Now!'}
          </h1>

          {/* Paragraph */}
          <p className="text-center text-gray-800 text-base md:text-sm mb-4 md:mb-8 font-light">
