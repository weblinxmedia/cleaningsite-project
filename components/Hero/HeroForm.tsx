    ...
    <form onSubmit={handleSubmit(onSubmit)} className="w-[100%] md:w-[80%] mx-auto md:w-full mt-8">
      ...
      <div className='flex w-full items-center justify-center'>
        <button
          ...
          className={`w-fit font-parkinsans nav-font px-7.5 mx-auto bg-luxury-pink py-3.5 text-sm text-luxury-lite font-medium tracking-normal rounded-full cursor-pointer transition-all duration-300 transform hover:scale-[1] ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-luxury-dark hover:bg-luxury-pink hover:shadow-lg'
            }`}
        >
