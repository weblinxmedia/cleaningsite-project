  ...
  ({ options, error, className = '', ...props }, ref) => {
    return (
      <div className="flex flex-col w-full">
        <select
          ref={ref}
          className={`w-full px-2 md:px-4 py-2.5 md:py-3.5  bg-white border ${error ? 'border-red-400 focus:ring-red-300' : 'border-gray-400 focus:ring-luxury-pink'} rounded-md text-xs md:text-sm text-gray-800 focus:outline-none focus:ring-2 appearance-none cursor-pointer transition-all duration-200 ${className}`}
          style={{
